...
from networks.provable.model.conv_sn_chen import conv_spectral_norm
from networks.provable.model.bn_sn_chen import bn_spectral_norm

class DnCNN(nn.Module):
    def __init__(self, channels, num_of_layers=17, lip=1.0, no_bn=False,
                 adaptive=False, tag='denoiser'):
