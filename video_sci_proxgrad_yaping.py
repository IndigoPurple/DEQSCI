...
parser.add_argument('--savepath',
                    default="/home/yaping/projects/deep_equilibrium_inverse/save/pretest_dncnn/")
...
if not inference:
    sci_equilibrium_training.train_solver_sci(
                               ...
                               start_epoch=start_epoch, train_img_path=save_train_img_path, test_img_path=save_test_img_path, best_img_path=save_best_img_path, tflog_path=tflog_location)
else:
    sci_equilibrium_training.test_solver_sci(test_dataloader=test_dataloader,
